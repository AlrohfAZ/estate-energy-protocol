...
4. STATE AND LIFECYCLE:
   ...
   ENERGY PRODUCTION FLOW: 1. The producers submits production claims. 2. The oracle validates the claim, and triggers minting. 3. Tokens are minted to producer.
   ENERGY CONSUMER FLOW: 1. The consumer buys the EnergyTokens. 2. The consumer converts the EnergyTokens to UsageUnits. 3. The usage ledger(UsageUnitVault) record is updated. 4. Usage of the units generates only record and not value.
